...
def main():
    ...
    for seqrecord in args.inseqs:
        ...
        # Here we hardcod `naive` as the translation for the inferred_naive_name, and this is now assumed
        # in `bin/mkconfig.py`
        new_id = "naive" if seqrecord.id == args.inferred_naive_name else "seq-{}".format(i)
